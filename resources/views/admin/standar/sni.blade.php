...
<section class="content">
    <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Statistik Permintaan SNI | Unit Kerja</h3>
    ...
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Tabel Permintaan Standar SNI | Unit Kerja</h3>
    ...
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Tabel Permintaan Standar SNI | Nomor Standar</h3>
          ...
          <div class="box-body">
            <div class="container-fluid">
                <table class="table table-hover"  id="sni-dt">
                    <thead>
                        <tr>
                            <th>Nomor Standar</th>
                            <th>Sestama</th>
