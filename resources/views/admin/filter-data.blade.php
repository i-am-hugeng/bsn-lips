...
{{-- <section class="content-header">
  ...
  <section class="content">
    ...
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Filter Laporan Permintaan Standar | Dari Tanggal <strong>{{$from_date->format('d-m-Y')}}</strong> sampai tanggal <strong>{{$to_date->subDay(1)->format('d-m-Y')}}</strong></h3>
        ...
        <div class="box-header with-border">
            ...
            <div class="container-fluid">
                <table class="table table-hover"  id="datatable-petugas">
                    ...
                    <tbody>
                    @foreach ($data_tabel_petugas_filter as $data)
                        <tr>
                            <td>{{$data->petugas}}</td>
  ...
  <script>
        ...
        Highcharts.chart('container-layanan', {
                ...
                series: [{
                    name: 'Permintaan',
                    data: [
                        { name: 'Terlayani ('+{{$terlayani_filter}}+' permintaan)', y: {{$terlayani_filter}} },
                        { name: 'Tidak Terlayani ('+{{$tidak_terlayani_filter}}+' permintaan)', y: {{$tidak_terlayani_filter}} },
                    ]
                }]
            });
        ...
        Highcharts.chart('container-dokumen', {
                ...
                series: [{
                    name: 'Permintaan',
                    data: [
                        { name: 'Tersedia ('+{{$tersedia_filter}}+' judul)', y: {{$tersedia_filter}} },
                        { name: 'Tidak Tersedia ('+{{$tidak_tersedia_filter}}+' judul)', y: {{$tidak_tersedia_filter}} },
                    ]
                }]
            });
  </script>
  ...
  <script>
    Highcharts.chart('containerBar', {
        ...
        title: {
            text: 'Statistik Unit Kerja | Bar Chart'
        },
        // subtitle: {
